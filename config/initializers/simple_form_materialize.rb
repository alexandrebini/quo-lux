...
SimpleForm.setup do |config|
  ...
  config.wrappers :materialize_form,
                  tag: 'div',
                  class: 'input-field col', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :materialize_text,
                  tag: 'div',
                  class: 'input-field col', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :materialize_toggle,
                  tag: 'p',
                  class: 'col switch', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :materialize_radio_and_checkboxes,
                  tag: 'div',
                  class: 'col', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
    b.use :input
  ...
  config.wrappers :materialize_file_input,
                  tag: 'div',
                  class: 'file-field input-field col', error_class: 'has-error' do |b|
    b.use :html5
  ...
  config.wrappers :materialize_multiple_file_input,
    ...
    b.wrapper tag: :div, class: 'file-path-wrapper' do |ba|
      ba.use :tag,
             tag: :input,
             class: 'file-path validate', type: 'text', placeholder: 'Upload one or more files'
    end
